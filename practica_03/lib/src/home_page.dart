        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButton(
                value: _valor,
                items: [
                  DropdownMenuItem(child: Text('Mujer'), value: 1),
                  DropdownMenuItem(child: Text('Hombre'), value: 2),
                ],
                onChanged: (int? selected) {
                  //ya cambio esto, la otra opcion me da error
                  setState(() {
                    _valor = selected!;
                  });
                }),
